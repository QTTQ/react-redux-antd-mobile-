...
Mock.mock('/qaz1', {
    status: 2000,
    data: {
        carouselBlogList: [{ blogId: 1, title: 'first blog', titleImgUrl: './images/1.PNG' },
        { blogId: 2, title: 'second blog', titleImgUrl: './images/2.PNG' },
        { blogId: 3, title: 'third blog', titleImgUrl: './images/3.PNG' }]
    }
});
...
Mock.mock('/bloglist', {
    ...
    data: {
        ...
        currentPage: 1,
        pageNumber: 18,
        blogList: [{ blogId: 1, title: '我的第一篇博客', titleImgUrl: './images/20ev2.jpg', introduce: '我的第一篇博客' },
        { blogId: 2, title: 'second blog', titleImgUrl: './images/123.PNG', introduce: '这是一篇新的博客，并没有什么内容' },
        { blogId: 3, title: 'third blog', titleImgUrl: './images/321.jpg', introduce: '这是一篇新的博客，并没有什么内容' },
        { blogId: 4, title: 'first blog', titleImgUrl: './images/20ev2.jpg', introduce: '这是一篇新的博客，并没有什么内容' },
        { blogId: 5, title: 'second blog', titleImgUrl: './images/123.PNG', introduce: '这是一篇新的博客，并没有什么内容' },
        { blogId: 6, title: 'third blog', titleImgUrl: './images/321.jpg', introduce: '这是一篇新的博客，并没有什么内容' },
        { blogId: 7, title: 'first blog', titleImgUrl: './images/20ev2.jpg', introduce: '这是一篇新的博客，并没有什么内容' },
        { blogId: 8, title: 'second blog', titleImgUrl: './images/123.PNG', introduce: '这是一篇新的博客，并没有什么内容' },
        { blogId: 9, title: 'third blog', titleImgUrl: './images/321.jpg', introduce: '这是一篇新的博客，并没有什么内容' },
        { blogId: 10, title: 'first blog', titleImgUrl: './images/20ev2.jpg', introduce: '这是一篇新的博客，并没有什么内容' },
        { blogId: 11, title: 'second blog', titleImgUrl: './images/123.PNG', introduce: '这是一篇新的博客，并没有什么内容' },
        { blogId: 12, title: 'first blog', titleImgUrl: './images/20ev2.jpg', introduce: '这是一篇新的博客，并没有什么内容' },]
    }
});

Mock.mock('/bloglist/1', {
    status: 2000,
    data: {
        totalNumber: 207,
        currentPage: 1,
